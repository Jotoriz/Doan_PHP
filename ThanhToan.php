                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hoTen" name="hoTen"
                            value="<?php echo htmlspecialchars($khachHang['HoTen_KH']); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="diaChi">Địa chỉ:</label>
                        <input type="text" class="form-control" id="diaChi" name="diaChi"
                            value="<?php echo htmlspecialchars($khachHang['DiaChi_KH']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="sdt">Số điện thoại:</label>
                        <input type="text" class="form-control" id="sdt" name="sdt"
                            value="<?php echo htmlspecialchars($khachHang['SDT_KH']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" class="form-control" id="email" name="email"
                            value="<?php echo htmlspecialchars($khachHang['Email_KH']); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <h2>Hình thức thanh toán:</h2><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="thanhToan" id="COD" value="COD" checked
                                disabled>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-6">
                    <input type="hidden" name="selected_products"
                        value='<?php echo json_encode($selected_products); ?>'>
