<?php
    ...
    function ThemNV($pdo)
    {
        if (isset($_POST["btn_Add"])) {
            ...
            if(isset($_POST["new_name"]) && isset($_POST["new_gender"]) && isset($_POST["new_phone"]) && isset($_POST["new_address"]) && isset($_POST["new_email"]) && isset($_POST["new_position"]) && isset($_POST["new_account"]) && isset($_POST["new_password"])) {
                ...
                $New_TenDangNhap = $_POST["new_account"];
                $New_MatKhau = $_POST["new_password"];

                // Thực hiện truy vấn để thêm mới nhân viên
                $sql = "INSERT INTO NhanVien (HoTen_NV, GioiTinh, SDT_NV, DiaChi_NV, Email_NV, MaCV, TenDangNhap, MatKhau) VALUES (:New_HoTen, :New_GioiTinh, :New_SDT, :New_DiaChi, :New_Email, :New_ChucVu, :New_TenDangNhap, :New_MatKhau)";
                ...
                $stmt->execute(array(
                    ...
                    ':New_TenDangNhap' => $New_TenDangNhap,
...
<body>
    ...
    <form method="POST" class="text-center">
        ...
        <!-- Nhập thông tin mới của nhân viên -->
        <input type="text" name="new_account" placeholder="Tên đăng nhập">
