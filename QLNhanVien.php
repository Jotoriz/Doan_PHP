            ...
            <div class="row mb-6">
                <div class="col-md-6 offset-md-6">
                    <form method="GET" action="" class="d-flex justify-content-end">
                        <input type="text" class="form-control mr-2" id="searchInput" name="keyword" placeholder="Tìm kiếm..." value="<?php echo htmlspecialchars($keyword); ?>" style="margin-right: 10px;">
